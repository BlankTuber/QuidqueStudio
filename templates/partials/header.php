<header class="main-header">
    ...
    <div class="main-header-right">
        <button class="theme-toggle" id="theme-toggle" title="Toggle theme" aria-label="Toggle theme">
            ...
            <svg class="theme-toggle-icon moon-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="display: none;">
                <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/>
            </svg>
        </button>
        
        <?php if ($auth['check']): ?>
            <span class="text-small text-secondary"><?= htmlspecialchars($auth['user']['username'] ?? '') ?></span>
        <?php endif; ?>
    </div>
</header>